            ...
            <form action="{{ route('gigs.update', ['gig' => $gig->id]) }}" method="POST" id="update-gig-form">
                ...
                <div class="flex flex-col space-y-4">
                        ...
                        <div class="bg-white px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                    ...
                                    <textarea id="description" name="description"class="@error('description') border-red-500 @enderror mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm h-[69px]">{{ old('description', $gig->description) }}</textarea>
                                    @error('description')
                                        <div class="alert text-red-500">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="flex justify-between mx-4 sm:mx-0">
                        ...
                        <button type="submit" id="update-gig-button" class="min-w-[110px] items-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                            Save
                        </button>
                    </div>
                </div>
